...
for(var i = 1; i < 6; i++ ){
    ...
    xhr.open("GET", "/cb_v4/static/core/js/pdf_templates/templatePDF_p"+ i +".png", true); 
...
//             console.log(rows1);
 ...
 //   var title = $('#title').val();
    ...
    doc.setFontSize(18);
    doc.setDrawColor(178, 12, 20);
    doc.setLineWidth(1);
    doc.line(0, 20, 270, 20);
    doc.line(0, 260, 270, 260);

    doc.setTextColor(178, 12, 20);
    doc.text(30,30,"Ficha de resultados del análisis costo beneficio social");
    doc.setFontSize(14);
    doc.text(10,72,"Nombre de la medida:");
    doc.text(10,52,"Nombre del proyecto:");
    doc.text(10,  92, "Elaboró: ");
    doc.text(10, 156, "Descripción de la medida: ");

    doc.setTextColor(36, 37, 41);
    doc.text(65, 72, doc.splitTextToSize(medida, 120));
    doc.text(65, 52, doc.splitTextToSize(proyecto, 120));
...
//  doc.addImage(template1[1], 'JPEG',0,0,215.9,279.4);
   ...
   doc.text(16, 226, "Índice Costo Efectividad"	);	
   ...
   doc.text(128, 226,"Pesos/" + resp.unidad_medida);
    
   doc.text(16, 233, "Cantidad generada"	);
   doc.text(16, 237, "con el proyecto");
   doc.text(70, 237, formatNumber(resp.cantidad_ice).substring(0,9));
   doc.text(128, 237,  resp.unidad_medida);
    ...
    doc.autoTable({
        ...
        didParseCell: function (table) {
          ...
          if (table.section === 'head') {
            table.cell.styles.fillColor = '#de5252';
          }
       }
